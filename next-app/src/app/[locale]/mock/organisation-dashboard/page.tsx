...
import { Delete, Eye, Users, Phone, Building2 } from 'lucide-react'
        ...
        <div className="mb-12 rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800/50">
          ...
          <div className="mt-6 grid gap-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Owner: Paul</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="mb-12 grid gap-6 md:grid-cols-3">
          <Card className="relative overflow-hidden">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium">Interview passed</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="relative overflow-hidden">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium">Top interviewer</CardTitle>
            </CardHeader>
            <CardContent>
